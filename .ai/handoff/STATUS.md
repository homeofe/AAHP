...
> Commit: (pending)
>
> Session (2026-07-14, v3.4.0 docs): extended the README spec. DONE:
> T-006 documented the `aahp status` CLI command plus a command reference table
> (section 7.1); T-007 added section 9 Consuming Harness Integration; T-008 added
> section 10 Multi-Repo and Cross-Repo Handoff plus the optional additive
> `cross_repo_ref` MANIFEST field (schema updated, npm minor bump 3.3.0 -> 3.4.0);
> T-009 inlined the condensed Grounding reference in section 2.10. All four content
> PRs (#28, #29, #30, #31) merged green.
>
