...
### ADR-021: section 2.4 provenance is a convention, and the audit-trail claim is withdrawn
...
### ADR-022: a path a document tells you to copy is a path a gate resolves
